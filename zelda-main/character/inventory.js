document.addEventListener("DOMContentLoaded", function () {
  ...
  // Sélectionnez le bouton "Ajouter une pomme" en utilisant querySelector
  let addAppleButton = document.querySelector("#addApple");

  // Sélectionnez l'inventaire de la pomme
  let appleInventory = document.getElementById("appleinventory");

  // Ajoutez un écouteur d'événements pour détecter les clics sur le bouton "Ajouter une pomme"
  addAppleButton.addEventListener("click", function () {
    // Affichez l'inventaire de la pomme
    appleInventory.classList.remove("hidden");
  });
});
